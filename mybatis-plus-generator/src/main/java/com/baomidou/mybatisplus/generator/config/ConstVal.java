...
public interface ConstVal {
    ...
    String CREATE_REQ_DTO = "CreateReqDTO";
    String UPDATE_REQ_DTO = "UpdateReqDTO";
    String PAGE_QUERY_REQ_DTO = "PageQueryReqDTO";
    String RESP_DTO = "RespDTO";
    String OTHER = "Other";
    ...
    String TEMPLATE_CREATE_REQ_DTO = "/templates/createReqDto.java";
    String TEMPLATE_UPDATE_REQ_DTO = "/templates/updateReqDto.java";
    String TEMPLATE_PAGE_QUERY_REQ_DTO = "/templates/pageQueryReqDto.java";
    String TEMPLATE_RESP_DTO = "/templates/respDto.java";
