...
public class PackageConfig {
     ...
     * Other包名
     */
    private String createDto = "dto.request";

    /**
     * Other包名
     */
    private String updateDto = "dto.request";

    /**
     * Other包名
     */
    private String pageDto = "dto.request";

    /**
     * Other包名
     */
    private String responseDto = "dto.response";
    ...
    public Map<String, String> getPackageInfo() {
        if (packageInfo.isEmpty()) {
            ...
            packageInfo.put(ConstVal.CREATE_REQ_DTO, this.joinPackage(this.getCreateDto()));
            packageInfo.put(ConstVal.UPDATE_REQ_DTO, this.joinPackage(this.getUpdateDto()));
            packageInfo.put(ConstVal.PAGE_QUERY_REQ_DTO, this.joinPackage(this.getPageDto()));
            packageInfo.put(ConstVal.RESP_DTO, this.joinPackage(this.getResponseDto()));
    ...
    public static class Builder implements IConfigBuilder<PackageConfig> {
        ...
        public Builder createDto(@NotNull String createDto) {
            this.packageConfig.createDto = createDto;
            return this;
        }

        public Builder updateDto(@NotNull String updateDto) {
            this.packageConfig.updateDto = updateDto;
            return this;
        }

        public Builder pageDto(@NotNull String pageDto) {
            this.packageConfig.pageDto = pageDto;
            return this;
        }

        public Builder responseDto(@NotNull String responseDto) {
            this.packageConfig.responseDto = responseDto;
            return this;
        }
