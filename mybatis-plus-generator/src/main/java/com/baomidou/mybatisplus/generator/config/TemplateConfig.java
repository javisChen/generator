...
public class TemplateConfig {
     ...
     * 设置控制器模板路径
     */
    private String updateReqDto;

    /**
     * 设置控制器模板路径
     */
    private String pageQueryReqDtp;

    /**
     * 设置控制器模板路径
     */
    private String respDto;
    ...
    private TemplateConfig() {
        ...
        this.createReqDto = ConstVal.TEMPLATE_CREATE_REQ_DTO;
        this.updateReqDto = ConstVal.TEMPLATE_UPDATE_REQ_DTO;
        this.pageQueryReqDtp = ConstVal.TEMPLATE_PAGE_QUERY_REQ_DTO;
        this.respDto = ConstVal.TEMPLATE_RESP_DTO;
    ...
    public String getCreateReqDto() {
        return createReqDto;
    }

    public String getUpdateReqDto() {
        return updateReqDto;
    }

    public String getPageQueryReqDtp() {
        return pageQueryReqDtp;
    }

    public String getRespDto() {
        return respDto;
    }
