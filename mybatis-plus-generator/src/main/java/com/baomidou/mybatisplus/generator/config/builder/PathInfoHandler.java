...
class PathInfoHandler {
    ...
    private void setDefaultPathInfo(GlobalConfig globalConfig, TemplateConfig templateConfig) {
        ...
        putPathInfo(templateConfig.getCreateReqDto(), OutputFile.createReqDto, ConstVal.CREATE_REQ_DTO);
        putPathInfo(templateConfig.getUpdateReqDto(), OutputFile.updateReqDto, ConstVal.UPDATE_REQ_DTO);
        putPathInfo(templateConfig.getPageQueryReqDtp(), OutputFile.pageQueryReqDto, ConstVal.PAGE_QUERY_REQ_DTO);
        putPathInfo(templateConfig.getRespDto(), OutputFile.respDto, ConstVal.RESP_DTO);
